    ...
    <body>
        <div class="container">
            ...
            <section class="contact-info">
                If you are the owner of this website, please contact your hosting provider: <a href="mailto:webmaster@goldmoney.pro">webmaster@goldmoney.pro</a>
            </section>
        ...
        <footer>
            <div class="container">
                <a href="http://cpanel.com/?utm_source=cpanelwhm&utm_medium=cplogo&utm_content=logolink&utm_campaign=cpanelwhmreferral" target="cpanel" title="cPanel, Inc.">
                    ...
                    <div class="copyright">Copyright © 2018 cPanel, Inc.</div>
                </a>
            </div>
        </footer>
    </body>
